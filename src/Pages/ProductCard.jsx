                ...
                <div id="slide1" className="carousel-item relative w-full" >
                    <div className="text-black bg-cover w-full flex justify-center items-center" style={{ backgroundImage: 'url("https://i.ibb.co/xzZfPpV/slider1.jpg")' }}>
                        <div className="text-center space-y-5">
                            ...
                            <button className="bg-[#176B87] text-white py-2 px-10 rounded-md">More</button>
                        </div>
                    </div>
                    ...
                    : <div className="flex justify-center items-center">
                        <div>
                            ...
                            <div className="space-y-10 text-center py-10">
                                <h3 className="max-md:text-3xl text-5xl text-center font-bold text-[#176B87] ">Visit other categories. <br /> This categories no product available now</h3>
