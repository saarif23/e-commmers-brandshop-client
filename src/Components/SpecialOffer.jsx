        ...
        <div className="max-w-6xl mx-auto my-10 " >
            ...
            <div className=" bg-blue-500 py-16 rounded-xl flex flex-col lg:flex-row items-center justify-center gap-16 max-md:px-5 ">
                <div className="space-y-3 text-center text-white">
                    <p className="max-md:text-base text-xl font-bold font-Roboto">TABLET COLLECTION 2023</p>
                    <h3 className="max-md:text-2xl text-5xl font-Playfair font-extrabold">Galaxy Tab S6 Lite
